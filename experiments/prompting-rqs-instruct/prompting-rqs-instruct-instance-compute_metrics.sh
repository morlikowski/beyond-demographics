...
do
    echo Computing metrics for llama3_instruct-$name-instance.json
    python3 -m multi_annotator.metrics experiments/prompting-rqs-instruct/llama3_instruct-$name-instance.json experiments/prompting-rqs-instruct/llama3_instruct-$name-instance.results.csv --is_discrete=True
done
