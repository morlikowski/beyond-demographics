...
do
    ...
    python3 -m multi_annotator.metrics experiments/long-prompting-rqs/llama3_instruct_long-$name-user.json experiments/long-prompting-rqs/llama3_instruct_long-$name-user.results.csv
done
